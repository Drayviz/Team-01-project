...
public class Pieces extends MetaGame
{
    ...
    public String namegenerator()
    {
        ...
        return First[r.nextInt(First.length)] + " " + Last[r.nextInt(First.length)];
    ...
    public void addHumanPieces(int prefab)
    {
        ...
        {
            //titan1
            Entity hPiece = new Entity(namegenerator(),1, 0, 4, 0, 2, 2,prefab);
            humanPieces.add(new Entity(hPiece));
        }
        if(prefab == 4)
        {
    ...
    public void addAIPieces(int prefab)
    {
        ...
        {
            //enemy titan
            Entity ePiece = new Entity(name, 1, 0, 2, 2, 1, 5, 2,prefab);
